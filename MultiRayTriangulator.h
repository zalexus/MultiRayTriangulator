...
// Объявляем кастомный класс плагина, наследуясь от DD::Image::Iop, чтобы интегрироваться в архитектуру графа Nuke
...
public: // Секция открытых виртуальных методов интерфейса NDK Nuke
    ...
    int maximum_inputs() const override; // Переопределение максимального количества входов (у ноды максимум 2 входа: Image и Camera)
